 ...
 * lensed, by various UI dataSourceComponents. UI dataSourceComponents should have only state needed
...
//    this.attribution = '';
//
//    // status and busy properties are be displayed in the UI,
...
//        this.status = `failed to resolve initialView entry: ${info}`;
//        this.error = true;
